...
class Ui_MainWindow1(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(30, 30, 381, 312))
    ...
    def sumbit(self):
        ...
        insert_stmt = (
            "INSERT INTO `devotees_details`(`name`, `address`, `state`, `email`, `phone`, `filename1`, `filename2`) VALUES (%s, %s, %s, %s, %s, %s ,%s)"
